import { IExecuteFunctions, IHookFunctions, ILoadOptionsFunctions, IDataObject, INode } from 'n8n-workflow';
...
export declare function formatSapODataValue(value: ODataValue, typeHint?: string, node?: INode): string;
