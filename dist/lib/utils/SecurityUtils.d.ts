...
export declare function buildSecureUrl(host: string, servicePath: string, resource: string, node: INode): string;
...
export declare function validateUrl(url: string, node: INode, options?: {
