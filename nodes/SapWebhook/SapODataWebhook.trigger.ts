 ...
 */
export class SapODataWebhookTrigger implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'SAP OData Webhook',
		name: 'sapODataWebhook',
		icon: 'file:sap.svg',
		group: ['trigger'],
		version: 1,
		subtitle: '={{$parameter["event"]}}',
		description: 'Receives SAP OData events via webhook (real-time notifications)',
		defaults: {
